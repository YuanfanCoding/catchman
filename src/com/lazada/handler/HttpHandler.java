...
public class HttpHandler {
	...
	public static void main(String[] args) {
		...
		try {
			Userinfo u = getUser("1016127734", "123456");
	...
	public static Userinfo getUser(String name, String password) throws ParseException, IOException {
		Userinfo ui = null;
		String body = "";
		// 创建httpclient对象
		...
		// System.out.println("请求参数："+EntityUtils.toString(new
	...
	public static boolean addUser(Userinfo ui) throws ParseException, IOException {
		...
		// 装填参数
//		List<NameValuePair> nvps = new ArrayList<NameValuePair>();
//		nvps.add(new BasicNameValuePair("userinfo", new Gson().toJson(ui)));
		// 设置参数到请求对象中
